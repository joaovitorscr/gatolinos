...
type DonationCardRootProps = ComponentProps<"article"> & {
  theme: "primary" | "secondary";
};

function DonationCardRoot({
  theme,
  className,
  ...props
}: DonationCardRootProps) {
  const baseClassName =
    theme === "primary"
...
function DonationCardContent({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      data-slot="donation-card-content"
...
function DonationCardAction({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      data-slot="donation-card-action"
...
export const DonationCard = Object.assign(DonationCardRoot, {
  Icon: DonationCardIcon,
  Title: DonationCardTitle,
  Description: DonationCardDescription,
  Content: DonationCardContent,
  Action: DonationCardAction,
});
