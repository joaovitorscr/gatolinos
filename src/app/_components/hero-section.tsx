...
export function HeroSection() {
  ...
  return (
    ...
    >
      <div className="default-shell grid items-center gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(20rem,0.9fr)] lg:gap-16">
        <motion.div
        ...
        >
          ...
          <Motion.h1
            className="mt-7 max-w-4xl text-balance font-headline text-5xl font-extrabold leading-[0.95] tracking-tighter text-primary sm:text-6xl lg:text-7xl"
            variants={{
          ...
          >
            Este é o cantinho onde transformamos ronronados em esperança. Explore, apaixone-se e
            ajude-nos a mudar vidas, segurando nossa patinha com doações, apadrinhamento e carinho.
          </Motion.p>
          <motion.div
        ...
        <div className="order-1 lg:order-2">
          <motion.div
            ...
            initial={shouldReduceMotion ? false : { opacity: 0, scale: 0.96, y: 28, rotate: -3 }}
            animate={shouldReduceMotion ? undefined : { opacity: 1, scale: 1, y: 0, rotate: 0 }}
            transition={{
              duration: 0.7,
              delay: 0.18,
              ease: easeOut,
          ...
          <motion.div
            className="relative -mt-10 ml-4 max-w-60 rounded-[1.75rem] bg-white/90 p-5 shadow-[0_24px_60px_-28px_rgba(61,38,17,0.32)] ring-1 ring-outline-variant/30 backdrop-blur xl:-mt-16"
            initial={shouldReduceMotion ? false : { opacity: 0, x: -14, y: 22, scale: 0.97 }}
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-headline text-3xl font-bold text-primary">Amor em ação</p>
              </div>
            </div>
          </motion.div>
        </div>
