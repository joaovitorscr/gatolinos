...
type SectionIntroProps = ComponentProps<"div"> & {
  align?: "left" | "center";
  invert?: boolean;
};

function SectionIntro({ align = "left", invert = false, className, ...props }: SectionIntroProps) {
  const alignmentClassName = align === "center" ? "mx-auto max-w-2xl text-center" : "max-w-2xl";
  ...
  return (
    <p
      ...
      className={cn(
        ...
        invert ? "text-[rgba(201,232,240,0.82)]" : "text-on-surface-variant",
        className,
      )}
      {...props}
    />
...
export { SectionIntro, SectionIntroEyebrow, SectionIntroTitle, SectionIntroDescription };
